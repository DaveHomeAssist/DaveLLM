...
Write-Host "=== DaveLLM Node Setup: Katana 1 (RTX 4060) ===" -ForegroundColor Cyan
...
Write-Host "Pulling deepseek-coder-v2:16b (code generation model)..." -ForegroundColor Yellow
