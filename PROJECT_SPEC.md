...
| `DAVE_ENABLE_EXTENDED_TOOLS` | No | Opt-in for the read-only `file.list`, `file.search`, and `file.read_lines`, honored only with `DAVE_ENABLE_TOOLS`; false. See `docs/DAVELLM_TOOLS.md`. |
