...
DaveHarness `0.4.0` added policy, fingerprints, and budgets. Version `0.5.0` adds a separate serializable run-state contract; DaveLLM's current HTTP routes remain on their shipped adapter until H7.
