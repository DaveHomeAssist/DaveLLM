...
| [DaveHarness implementation plan](docs/DAVEHARNESS_IMPLEMENTATION_PLAN.md) | Authoritative 60-action roadmap through shipped `0.2.0` execution semantics, `0.3.0` leaf contracts, `0.4.0` policy and budgets, and `0.5.0` run state toward a qualified `1.0.0` contract. |
